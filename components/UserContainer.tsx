...
export default function UserContainer({ user, createdAt, inline }: UserContainerProps) {
  ...
  const infoContainerClasses = inline ? 'flex flex-col sm:flex-row sm:items-center sm:w-full sm:justify-between' : '';
